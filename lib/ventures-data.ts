...
export const VENTURES: Venture[] = [
  {
    ...
    bounties: [
      { id: "sc-1", title: "Build screenplay diff viewer with inline comments", equity: 2.5, status: "open", tags: ["Frontend", "React"] },
      { id: "sc-2", title: "Implement real-time co-writing session via WebSockets", equity: 3.2, status: "open", tags: ["Backend", "WebSockets"] },
      { id: "sc-3", title: "Export to Final Draft (.fdx) format", equity: 1.8, status: "open", tags: ["Backend", "Parsing"] },
      { id: "sc-4", title: "Build payments dashboard with Stripe", equity: 3.0, status: "completed", tags: ["Payments", "Frontend"] },
      { id: "sc-5", title: "Character relationship graph visualization", equity: 2.0, status: "completed", tags: ["Frontend", "D3"] },
    ],
  },
  {
    id: "tutorai",
    ...
    bounties: [
      { id: "ta-1", title: "Build adaptive quiz engine with spaced repetition", equity: 3.5, status: "open", tags: ["Backend", "AI"] },
      { id: "ta-2", title: "Student progress dashboard for teachers", equity: 2.8, status: "open", tags: ["Frontend", "Dashboard"] },
      { id: "ta-3", title: "iOS app for student-facing lessons", equity: 4.0, status: "open", tags: ["Mobile", "Swift"] },
      { id: "ta-4", title: "Integrate with Google Classroom API", equity: 2.2, status: "open", tags: ["Integration", "Backend"] },
    ],
  },
  {
    id: "legallens",
    ...
    bounties: [
      { id: "ll-1", title: "Implement document RAG pipeline with Pinecone", equity: 4.5, status: "open", tags: ["Backend", "AI/ML"] },
      { id: "ll-2", title: "Build clause library and comparison tool", equity: 3.0, status: "open", tags: ["Frontend", "Search"] },
    ],
  },
  {
    id: "metrik",
    ...
    bounties: [
      { id: "mk-1", title: "Build Prometheus-compatible metrics ingestion API", equity: 4.0, status: "open", tags: ["Backend", "Go"] },
      { id: "mk-2", title: "Real-time alerting engine with webhook delivery", equity: 3.5, status: "open", tags: ["Backend", "Infrastructure"] },
      { id: "mk-3", title: "Grafana-compatible dashboard builder", equity: 5.0, status: "open", tags: ["Frontend", "Data Viz"] },
      { id: "mk-4", title: "Multi-tenant access control and audit log", equity: 3.0, status: "open", tags: ["Backend", "Security"] },
      { id: "mk-5", title: "OpenTelemetry collector sidecar", equity: 4.5, status: "open", tags: ["DevOps", "Go"] },
    ],
  },
  {
    id: "harvesthq",
    ...
    bounties: [
      { id: "hq-1", title: "Supplier catalog integration with EDI standards", equity: 3.0, status: "open", tags: ["Backend", "EDI"] },
      { id: "hq-2", title: "Inventory forecasting model (time-series)", equity: 4.0, status: "open", tags: ["AI/ML", "Python"] },
      { id: "hq-3", title: "Purchase order approval workflow UI", equity: 2.5, status: "open", tags: ["Frontend", "React"] },
      { id: "hq-4", title: "SMS/WhatsApp delivery notification system", equity: 2.0, status: "open", tags: ["Backend", "Twilio"] },
      { id: "hq-5", title: "Restaurant operator mobile app (iOS)", equity: 4.5, status: "open", tags: ["Mobile", "Swift"] },
      { id: "hq-6", title: "Vendor performance analytics dashboard", equity: 3.0, status: "open", tags: ["Frontend", "Analytics"] },
    ],
  },
  {
    id: "melodex",
    ...
    bounties: [
      { id: "ml-1", title: "Audio generation pipeline (text-to-music via API)", equity: 5.0, status: "open", tags: ["Backend", "AI/ML"] },
      { id: "ml-2", title: "Prompt interface and style selector UI", equity: 3.5, status: "open", tags: ["Frontend", "React"] },
      { id: "ml-3", title: "Stem separation and download system", equity: 3.0, status: "open", tags: ["Backend", "Audio"] },
      { id: "ml-4", title: "Creator licensing contract (smart contract on Solana)", equity: 4.0, status: "open", tags: ["Blockchain", "Solana"] },
      { id: "ml-5", title: "Creator account and library management", equity: 2.5, status: "open", tags: ["Backend", "Auth"] },
      { id: "ml-6", title: "Stripe subscription + pay-per-track billing", equity: 2.0, status: "open", tags: ["Payments"] },
      { id: "ml-7", title: "SEO-optimized landing pages per genre/mood", equity: 1.5, status: "open", tags: ["Frontend", "SEO"] },
      { id: "ml-8", title: "YouTube Content ID integration", equity: 4.0, status: "open", tags: ["Integration", "Backend"] },
    ],
  },
];
